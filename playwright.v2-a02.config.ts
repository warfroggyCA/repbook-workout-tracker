...
const port = Number.parseInt(process.env.V2_A02_PORT ?? "3154", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-a02-provider-neutral-instructions.spec.ts"],
  outputDir: "./output/playwright/v2-a02/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
