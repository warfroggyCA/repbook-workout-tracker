...
const port = Number.parseInt(process.env.V2_U01_PORT ?? "3136", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-u01-active-workout-hierarchy.spec.ts"],
  outputDir: "./output/playwright/v2-u01/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
