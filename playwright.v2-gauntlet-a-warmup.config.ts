...
const port = Number.parseInt(process.env.V2_GAUNTLET_A_WARMUP_PORT ?? "3140", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-t04-warmup-occurrences.spec.ts"],
  outputDir: "./output/playwright/v2-gauntlet-a-warmup/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
