...
const port = Number.parseInt(process.env.V2_A03_PORT ?? "3156", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-a03-typed-response-schema.spec.ts"],
  outputDir: "./output/playwright/v2-a03/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
