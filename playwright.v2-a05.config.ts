...
const port = Number.parseInt(process.env.V2_A05_PORT ?? "3160", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-a05-selective-review-bridge.spec.ts"],
  outputDir: "./output/playwright/v2-a05/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
