...
export function WorkoutStatusBar({
  ...
  return (
    <aside
      ...
      className={cn(
        "fixed inset-x-0 bottom-[calc(4rem+env(safe-area-inset-bottom))] z-30 border-t bg-background shadow-[0_-5px_18px_rgb(0_0_0/0.12)] max-[359px]:bottom-[env(safe-area-inset-bottom)] lg:bottom-0 lg:left-[var(--main-sidebar-width)]",
        timerReady &&
    ...
    >
      ...
      >
        ...
        >
          <span className="block break-words text-xs font-semibold leading-tight max-[359px]:sr-only sm:text-sm">
            {title}
          </span>
          <span
            role="status"
