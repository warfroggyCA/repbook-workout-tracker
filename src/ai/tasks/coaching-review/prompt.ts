...
Rules:
- Ground every highlight in specific supplied evidence such as a named exercise, date, session count, planned-set outcome rate, pain flag, fatigue check-in, or trend.
