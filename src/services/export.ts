  ...
  const exportedRows = [
    ...rows.map((r) => ({
      ...
      values: [
        ...
        r.plannedExerciseId ? plannedExerciseNames.get(r.plannedExerciseId) : null,
        ...
        r.isWarmup, r.targetMet,
        r.targetLoad, r.targetLoadUnit, r.targetRepsMin, r.targetRepsMax, r.note, r.sourceSetIndex,
