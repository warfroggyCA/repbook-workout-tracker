...
export async function buildSetsCsv(
  ...
  const rows = await db
    .select({
      ...
      timedPrescription: sessionExercises.timedPrescription,
  ...
  const exportedRows = [
    ...rows.map((r) => {
      ...
      values: [
        ...
        r.timedPrescription == null ? null : JSON.stringify(r.timedPrescription),
  ...
  return toCsv(
    [
      ...
      "timed_prescription_json", "exercise_order", "superset_key",
