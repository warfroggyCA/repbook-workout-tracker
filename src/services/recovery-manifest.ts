...
export const RECOVERY_TABLE_MANIFEST = [
  ...
  entry("recommendations", "Recommendations", "direct_user", "recommendations.user_id", ["users", "exercises", "progression_jobs", "workout_template_exercises", "archive_operations"], "canonical", "replace", "replace", linked, cascade, durable, ["owner", "source references", "decision consistency", "versioned evidence and proposed future effect", "review and defer revisions", "coherent durable defer state"]),
  entry("user_decisions", "Recommendation decisions", "parent_chain", "user_decisions.recommendation_id -> recommendations.user_id", ["recommendations"], "canonical", "replace", "replace", linked, cascade, durable, ["recommendation reference", "one decision", "immutable evidence and proposal snapshot at decision time"]),
