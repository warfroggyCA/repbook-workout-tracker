...
export const RECOVERY_TABLE_MANIFEST = [
  ...
  entry("session_exercises", "Workout exercises", "parent_chain", "session_exercises.session_id -> workout_sessions.user_id", ["workout_sessions", "exercises", "session_exercise_groups"], "canonical", "replace", "replace", linked, cascade, durable, ["workout reference", "exercise reference", "load unit", "same-workout group membership", "stable source slot lineage"]),
  ...
  entry("completed_sets", "Completed sets", "parent_chain", "completed_sets.session_exercise_id -> workout_sessions.user_id", ["session_exercises"], "canonical", "replace", "replace", linked, cascade, durable, ["workout exercise reference", "stable client identity", "load unit", "immutable versioned performed measurement and load semantics", "immutable server recording time", "nullable observed completion with provenance and quality"]),
  ...
  entry("pain_logs", "Pain records", "direct_user", "pain_logs.user_id", ["users", "workout_sessions", "exercises", "archive_operations"], "canonical", "replace", "replace", linked, cascade, durable, ["owner", "optional workout/exercise reference"]),
  ...
  entry("recommendations", "Recommendations", "direct_user", "recommendations.user_id", ["users", "exercises", "progression_jobs", "workout_template_exercises", "archive_operations"], "canonical", "replace", "replace", linked, cascade, durable, ["owner", "source references", "decision consistency"]),
  entry("user_decisions", "Recommendation decisions", "parent_chain", "user_decisions.recommendation_id -> recommendations.user_id", ["recommendations"], "canonical", "replace", "replace", linked, cascade, durable, ["recommendation reference", "one decision"]),
  entry("adaptation_events", "Applied adaptations", "direct_user", "adaptation_events.user_id", ["users", "recommendations"], "canonical", "replace", "replace", linked, cascade, durable, ["owner", "recommendation reference", "one adaptation"]),
