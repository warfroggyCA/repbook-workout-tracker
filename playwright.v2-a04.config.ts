...
const port = Number.parseInt(process.env.V2_A04_PORT ?? "3158", 10);

export default defineConfig({
  testDir: "./tests/e2e",
  testMatch: ["v2-a04-ai-response-validation.spec.ts"],
  outputDir: "./output/playwright/v2-a04/test-results",
  fullyParallel: false,
  workers: 1,
  maxFailures: 1,
  retries: 0,
